...
namespace auge
{
	...
	extern "C"
	{
		...
		AUGE_API g_int		auge_move(const char* src, const char* des);
		AUGE_API g_int		auge_rename(const char* src, const char* des);
		AUGE_API g_int		auge_remove_file(const char* path);
		...
		AUGE_API void		auge_str_trim_last_r_n(char* str);
		...
		AUGE_API void		auge_get_time_struct(TIME_STRU* time_stru);
		AUGE_API void		auge_get_sys_time_as_string(char* sztime, size_t size);
		AUGE_API void		auge_get_sys_time_as_format_string(char* sztime, size_t size);
		...
		AUGE_API bool		auge_web_parameter_encoding(const char* input, char* output, size_t output_size, bool isIE);
	}
}
