...
namespace auge
{
	...
	public:
		...
		virtual RESULTCODE			AddRaster(const char* name, Raster* pRaster, const char* uuid) = 0;
		virtual RESULTCODE			AddRaster(const char* name, const char* raster_path, const char* uuid) = 0;
