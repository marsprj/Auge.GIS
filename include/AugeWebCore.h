...
namespace auge
{
	...
	public:
		...
		virtual GStatistics*	StatisticsByClient(g_int user_id, const char* client, const char* field) = 0;
		virtual GStatistics*	StatisticsByClient(g_int user_id, const char* client, const char* field, const char* start_time, const char* end_time) = 0; 
