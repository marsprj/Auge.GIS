...
namespace auge
{
	...
	{ 
		...
		m_handlers.push_back(new DescribeLayerHandler());
		...
		m_handlers.push_back(new JobStatisticsHandler());
	}
	...
	void WEngine::Begin(WebRequest* pWebRequest, WebContext* pWebContext, User* pUser)
	{ 
