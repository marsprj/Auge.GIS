...
[ HTTP Get ]
-------------------------------------------------------------------------
service=dbs&version=1.0.0&request=GetDataSet&sourceName=db1&dataSetName=cities
http://127.0.0.1:8088/ows/user1/mgr?service=dbs&version=1.0.0&request=GetDataSet&sourceName=db1&dataSetName=cities
