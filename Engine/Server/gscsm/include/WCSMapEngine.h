#ifndef __AUGE_WEB_CSMAP_ENGINE_H__
#define __AUGE_WEB_CSMAP_ENGINE_H__
...
namespace auge
{
	...
	class WCSMapEngine : public WebEngine
	{
		friend class CapabilitiesHandler;

	public:
		WCSMapEngine();
		virtual ~WCSMapEngine();
...
#endif //__AUGE_WEB_CSMAP_ENGINE_H__
