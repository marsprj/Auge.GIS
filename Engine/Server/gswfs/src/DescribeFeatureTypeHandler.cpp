...
namespace auge
{
	...
	WebResponse* DescribeFeatureTypeHandler::Execute(WebRequest* pWebRequest, User* pUser)
	{
	...
	FeatureClass* DescribeFeatureTypeHandler::GetFeatureClass(WebRequest* pWebRequest, WebContext* pWebContext, User* pUser)
	{
