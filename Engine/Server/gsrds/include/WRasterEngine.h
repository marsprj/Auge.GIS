#ifndef __AUGE_WEB_RASTER_ENGINE_H__
#define __AUGE_WEB_RASTER_ENGINE_H__
...
namespace auge
{
	...
	class WRasterEngine : public WebEngine
	{
	public:
		WRasterEngine();
		virtual ~WRasterEngine();
...
#endif //__AUGE_WEB_RASTER_ENGINE_H__
