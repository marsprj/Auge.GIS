...
http://127.0.0.1:8088/ows/user1/mgr?service=rds&version=1.0.0&request=AddRaster&sourceName=rsdb&rasterName=Koala.png&rasterPath=/&filePath=/Koala.png
http://127.0.0.1:8088/ows/user1/mgr?service=rds&version=1.0.0&request=AddRaster&sourceName=rsdb&rasterName=Koala.png&rasterPath=/aaa&filePath=/Koala.png
