#ifndef __AUGE_GPS_RASTER_MASK_REQUEST_H__
#define __AUGE_GPS_RASTER_MASK_REQUEST_H__
...
namespace auge
{
	class RasterMaskRequest : public WebRequest
	{
	public:
		RasterMaskRequest();
		virtual ~RasterMaskRequest();
...
#endif //__AUGE_GPS_RASTER_MASK_REQUEST_H__
...
-------------------------------------------------------------------------
1)
service=gps&version=1.0.0&request=RasterMask&inputSourceName=rsdb&inputRasterName=Koala.png&outputSourceName=rsdb&outputRasterName=Koala_900913.png&extent=100,100,500,500
http://127.0.0.1:8088/ows/admin/mgr?service=gps&version=1.0.0&request=RasterMask&inputSourceName=rsdb&inputRasterName=cities&outputSourceName=rsdb&outputRasterName=cities_900913&outputSrid=900913
