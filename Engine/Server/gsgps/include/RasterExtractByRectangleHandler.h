#ifndef __AUGE_GPS_RASTER_EXTRACT_BY_RECTANGLE_PROJECT_HANDLER_H__
#define __AUGE_GPS_RASTER_EXTRACT_BY_RECTANGLE_PROJECT_HANDLER_H__
...
#endif //__AUGE_GPS_RASTER_EXTRACT_BY_RECTANGLE_PROJECT_HANDLER_H__
