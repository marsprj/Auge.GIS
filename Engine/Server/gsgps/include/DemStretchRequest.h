#ifndef __AUGE_GPS_DEM_STRETCH_REQUEST_H__
#define __AUGE_GPS_DEM_STRETCH_REQUEST_H__
...
namespace auge
{
	class DemStretchRequest : public WebRequest
	{
	public:
		DemStretchRequest();
		virtual ~DemStretchRequest();
...
#endif //__AUGE_GPS_DEM_STRETCH_REQUEST_H__
