#ifndef __AUGE_GPS_RASTER_HISTOGRAM_EQUALIZATION_REQUEST_H__
#define __AUGE_GPS_RASTER_HISTOGRAM_EQUALIZATION_REQUEST_H__
...
namespace auge
{
	class RasterHistogramEqualizationRequest : public WebRequest
	{
	public:
		RasterHistogramEqualizationRequest();
		virtual ~RasterHistogramEqualizationRequest();
...
#endif //__AUGE_GPS_RASTER_HISTOGRAM_EQUALIZATION_REQUEST_H__
...
-------------------------------------------------------------------------
1)
user=user1&service=gps&version=1.0.0&request=RasterHistogramEqualization&inputSourceName=rsdb2&inputRasterName=Koala.jpg&outputSourceName=rsdb2&outputRasterName=Koala_gray.jpg
http://182.92.114.80:8088/ows/admin/mgr?service=gps&version=1.0.0&request=RasterHistogramEqualization&inputSourceName=rsdb2&inputRasterName=Koala.jpg&outputSourceName=rsdb2&outputRasterName=Koala_gray.jpg
