#ifndef __AUGE_GPS_RASTER_HISTOGRAM_EQUALIZATION_HANDLER_H__
#define __AUGE_GPS_RASTER_HISTOGRAM_EQUALIZATION_HANDLER_H__
...
#endif //__AUGE_GPS_RASTER_HISTOGRAM_EQUALIZATION_HANDLER_H__
