#ifndef __AUGE_GPS_RASTER_THRESHOLD_REQUEST_H__
#define __AUGE_GPS_RASTER_THRESHOLD_REQUEST_H__
...
namespace auge
{
	class RasterThresholdRequest : public WebRequest
	{
	public:
		RasterThresholdRequest();
		virtual ~RasterThresholdRequest();
	...
	public:
		...
		augeRasterThresholder	GetThresholder();
	...
	public:
		...
		void		SetThresholder(const char* thresholder);
	...
	private:
		...
		augeRasterThresholder	m_thresolder;
		//////////////////////////////////////////////////////////////////////////
...
#endif //__AUGE_GPS_RASTER_THRESHOLD_REQUEST_H__
...
-------------------------------------------------------------------------
1)
service=rds&version=1.0.0&request=GetRaster&sourceName=rsdb2&rasterName=Koala_smooth.jpg&Path=/&thresholer=average
http://182.92.114.80:8088/ows/user1/mgr?service=rds&version=1.0.0&request=GetRaster&sourceName=rsdb2&rasterName=Koala_smooth.jpg&Path=/&thresholer=average
