...
http://123.57.207.198/ows/admin/mgr?service=gps&version=1.0.0&request=RasterSubtract&inputSourceName=rsdb&inputRasterName=cities&outputSourceName=rsdb&outputRasterName=cities_900913&outputSrid=900913

service=gps&version=1.0.0&request=RasterSubtract&inputSourceName=rsdb&inputRasterName=rivers&outputSourceName=rsdb&outputRasterName=rivers_900913&outputSrid=900913
http://127.0.0.1:8088/ows/admin/mgr?service=gps&version=1.0.0&request=RasterSubtract&inputSourceName=rsdb&inputRasterName=rivers&outputSourceName=rsdb&outputRasterName=rivers_900913&outputSrid=900913

service=gps&version=1.0.0&request=RasterSubtract&inputSourceName=rsdb&inputRasterName=country&outputSourceName=rsdb&outputRasterName=country_900913&outputSrid=900913
http://127.0.0.1:8088/ows/admin/mgr?service=gps&version=1.0.0&request=RasterSubtract&inputSourceName=rsdb&inputRasterName=country&outputSourceName=rsdb&outputRasterName=country_900913&outputSrid=900913

//service=gps&version=1.0.0&request=RasterSubtract&sourceName=db1&RasterName=cities&distancefeild=id
//http://127.0.0.1:8088/ows/admin/mgr?service=gps&version=1.0.0&request=RasterSubtract&sourceName=db1&RasterName=cities&distancefeild=id
//http://123.57.207.198/ows/admin/mgr?service=gps&version=1.0.0&request=RasterSubtract&sourceName=db1&RasterName=cities&distancefeild=id

2)
service=gps&version=1.0.0&request=RasterSubtract&featureset=
	<FeatureCollection>
		<FeatureMember>
		</FeatureMember>
	</FeatureCollection>
...
-------------------------------------------------------------------------
1)
<RasterSubtract service="gps" version="1.0.0">
  <Input>
