...
************************************************************************/
	...
	void DemSlopeRequest::SetInputPath(const char* rasterPath)
	{
		if(rasterPath==NULL)
		{
			m_in_raster_path = "/";
	...
	void DemSlopeRequest::SetOutputPath(const char* rasterPath)
	{
		if(rasterPath==NULL)
		{
			m_out_raster_path = "/";
	...
	const char* DemSlopeRequest::GetInputPath()
	{
	...
	const char* DemSlopeRequest::GetOutputPath()
	{
