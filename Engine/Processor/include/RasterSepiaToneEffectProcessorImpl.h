#ifndef __AUGE_RASTER_SEPIA_TONE_EFFECT_IMPL_H__
#define __AUGE_RASTER_SEPIA_TONE_EFFECT_IMPL_H__
...
namespace auge
{
	class RasterSepiaToneEffectProcessorImpl : public RasterSepiaToneEffectProcessor
	{
	public:
		RasterSepiaToneEffectProcessorImpl();
		virtual ~RasterSepiaToneEffectProcessorImpl();
	public:
...
#endif //__AUGE_RASTER_SEPIA_TONE_EFFECT_IMPL_H__
