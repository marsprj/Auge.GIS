...
namespace auge
{
	...
	void RasterEdgeDetectProcessorImpl::SetInputPath(const char* rasterPath)
	{
		if(rasterPath==NULL)
		{
	...
	void RasterEdgeDetectProcessorImpl::SetOutputPath(const char* rasterPath)
	{
		if(rasterPath==NULL)
		{
	...
	const char* RasterEdgeDetectProcessorImpl::GetInputRasterPath()
	{
		return m_in_raster_path.empty() ? NULL : m_in_raster_path.c_str();
	}

	const char* RasterEdgeDetectProcessorImpl::GetOutputRasterPath()
	{
