...
namespace auge
{
	...
	*/
	...
	RESULTCODE SQLBuilder::BuildIntersectsFilter(std::string& sql,FeatureClassByd* pFeatureClass, BinarySpatialFilter* pFilter)
	{
		RESULTCODE rc = AG_SUCCESS;
		Geometry* pGeometry = pFilter->GetGeometry();
		if(pGeometry==NULL)
	...
	RESULTCODE SQLBuilder::BuildEqualsFilter(std::string& sql,FeatureClassByd* pFeatureClass, BinarySpatialFilter* pFilter)
	{
		RESULTCODE rc = AG_SUCCESS;
		Geometry* pGeometry = pFilter->GetGeometry();
		if(pGeometry==NULL)
	...
	RESULTCODE SQLBuilder::BuildDisjointFilter(std::string& sql,FeatureClassByd* pFeatureClass, BinarySpatialFilter* pFilter)
	{
		RESULTCODE rc = AG_SUCCESS;
		Geometry* pGeometry = pFilter->GetGeometry();
		if(pGeometry==NULL)
	...
	RESULTCODE SQLBuilder::BuildCrossFilter(std::string& sql,FeatureClassByd* pFeatureClass, BinarySpatialFilter* pFilter)
	{
		RESULTCODE rc = AG_SUCCESS;
		Geometry* pGeometry = pFilter->GetGeometry();
		if(pGeometry==NULL)
	...
	RESULTCODE SQLBuilder::BuildContainsFilter(std::string& sql,FeatureClassByd* pFeatureClass, BinarySpatialFilter* pFilter)
	{
		RESULTCODE rc = AG_SUCCESS;
		Geometry* pGeometry = pFilter->GetGeometry();
		if(pGeometry==NULL)
	...
	RESULTCODE SQLBuilder::BuildTouchesFilter(std::string& sql,FeatureClassByd* pFeatureClass, BinarySpatialFilter* pFilter)
	{
		RESULTCODE rc = AG_SUCCESS;
		Geometry* pGeometry = pFilter->GetGeometry();
		if(pGeometry==NULL)
	...
	RESULTCODE SQLBuilder::BuildOverlapsFilter(std::string& sql,FeatureClassByd* pFeatureClass, BinarySpatialFilter* pFilter)
	{
		RESULTCODE rc = AG_SUCCESS;
		Geometry* pGeometry = pFilter->GetGeometry();
		if(pGeometry==NULL)
