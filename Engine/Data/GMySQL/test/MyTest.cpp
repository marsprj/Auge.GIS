...
void MyTest::setUp() 
{
	const char* path = "SERVER=127.0.0.1;INSTANCE=3306;DATABASE=test;USER=root;PASSWORD=qwer1234;ENCODING=GBK";
...
void MyTest::QueryBinaryComparision()
{
