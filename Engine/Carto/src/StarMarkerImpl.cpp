...
namespace auge
{
	...
	RESULTCODE StarMarkerImpl::Draw(WKBPoint* pWKBPoint, Renderer* pRenderer, Transformation* pTransform)
	{
		if(m_size==0)
		{
			return AG_FAILURE;
	...
	RESULTCODE StarMarkerImpl::Draw(WKBMultiPoint* pWKBMultiPoint, Renderer* pRenderer, Transformation* pTransform)
	{
