...
namespace auge
{
	GrassLandSymbolImpl::GrassLandSymbolImpl():
	m_cairo(NULL),
	m_icon(NULL),	
	m_opacity(0.0f),
	m_size(5.0f),
	...
	//////////////////////////////////////////////////////////////////////////
	const char*	GrassLandSymbolImpl::GetName()
	{
		return "GrassLand";
	}

	const char*	GrassLandSymbolImpl::GetIcon()
	{
	...
	bool GrassLandSymbolImpl::IsGraphic()
	{
		return false;
	}

	augeMarkerType GrassLandSymbolImpl::GetMarkType()
	{
		return augeMarkerSquare;
	}
	
	void GrassLandSymbolImpl::SetStroke(Stroke* pStroke)
	{
		//if(m_pStroke!=NULL)
		//{
		//	m_pStroke->Release();
	...
	Stroke* GrassLandSymbolImpl::GetStroke()
	{
		return m_pStroke;
	}

	void GrassLandSymbolImpl::SetFill(Fill* pFill)
	{
		//if(m_pFill!=NULL)
		//{
		//	m_pFill->Release();
	...
	Fill*	GrassLandSymbolImpl::GetFill()
	{
		return m_pFill;
	}

	void GrassLandSymbolImpl::SetOpacity(float opacity)
	{
		m_opacity = opacity;
	}

	float GrassLandSymbolImpl::GetOpacity()
	{
		return m_opacity;
	}

	void GrassLandSymbolImpl::SetSize(float size)
	{
		m_size = size;
	}

	float GrassLandSymbolImpl::GetSize()
	{
		return m_size;
	}

	void GrassLandSymbolImpl::SetRotation(float rotation)
	{
		m_rotation = rotation;
	}

	float GrassLandSymbolImpl::GetRotation()
	{
		return m_rotation;
	}

	void GrassLandSymbolImpl::Release()
	{
		if(!ReleaseRef())
		{
			delete this;
	...
	augeSymbolizerType GrassLandSymbolImpl::GetType()
	{
		return augeSymbolPoint;
	}

	RESULTCODE GrassLandSymbolImpl::Draw(Geometry* pGeometry, Renderer* pRenderer, Transformation* pTransform)
	{
		if(pGeometry==NULL)
		{
			return AG_FAILURE;
	...
	void GrassLandSymbolImpl::DrawIcon()
	{
	...
	void GrassLandSymbolImpl::SaveIcon(const char* icon_path)
	{
		cairo_surface_write_to_png(m_icon, icon_path);
	}

	Symbol*	GrassLandSymbolImpl::Clone()
	{
		return (new GrassLandSymbolImpl());
	}
}
