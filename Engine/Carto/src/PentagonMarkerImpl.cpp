...
namespace auge
{
	...
	const char*	PentagonMarkerImpl::GetIcon()
	{
	...
	RESULTCODE PentagonMarkerImpl::Draw(WKBPoint* pWKBPoint, Renderer* pRenderer, Transformation* pTransform)
	{
		if(m_size==0)
		{
			return AG_FAILURE;
	...
	RESULTCODE PentagonMarkerImpl::Draw(WKBMultiPoint* pWKBMultiPoint, Renderer* pRenderer, Transformation* pTransform)
	{
	...
	void PentagonMarkerImpl::DrawSymbol()
	{
	...
	void PentagonMarkerImpl::SaveIcon(const char* icon_path)
	{
