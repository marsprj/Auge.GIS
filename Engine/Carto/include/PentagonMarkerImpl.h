#ifndef __AUGE_PENTAGON_MARKER_IMPL_H__
#define __AUGE_PENTAGON_MARKER_IMPL_H__
...
namespace auge
{
	class PentagonMarkerImpl : public PentagonMarker
	{
	public:
		PentagonMarkerImpl();
		virtual ~PentagonMarkerImpl();
...
#endif //__AUGE_PENTAGON_MARKER_IMPL_H__
