#ifndef __AUGE_SQUARE_MARKER_IMPL_H__
#define __AUGE_SQUARE_MARKER_IMPL_H__
...
namespace auge
{
	class SquareMarkerImpl : public SquareMarker
	{
	public:
		SquareMarkerImpl();
		virtual ~SquareMarkerImpl();
...
#endif //__AUGE_SQUARE_MARKER_IMPL_H__
